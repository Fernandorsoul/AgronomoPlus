...
/// <summary>
/// Modelo para composição de solo (análise de solo).
/// Corrigido: Nome da classe alterado de AnaliseDeSolo para ComposicaoDeSolo para corresponder às interfaces.
/// </summary>
public class ComposicaoDeSolo
{
    ...
    public string Recomendacoes { get; set; } = string.Empty;  // Texto com sugestões de correção
